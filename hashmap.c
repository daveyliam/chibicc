...
void *hashmap_get(HashMap *map, char *key) { return hashmap_get2(map, key, strlen(key)); }
...
void hashmap_put(HashMap *map, char *key, void *val) { hashmap_put2(map, key, strlen(key), val); }
...
void hashmap_delete(HashMap *map, char *key) { hashmap_delete2(map, key, strlen(key)); }
